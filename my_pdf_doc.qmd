...
The fitting result is $mpg = `r b[1]` + `r b[2]``r params$xvarA`$.
Below is a scatter plot with the regression line.

```{r plotA, fig.height=5}
par(mar = c(4, 4, 1, 1))
plot(as.formula(paste('mpg ~', params$xvarA)), data = mtcars, pch = 19, col = 'gray')
abline(fit, col = 'red', lwd = 2)
```

```{r plotB, fig.height=5}
par(mar = c(4, 4, 1, 1))
plot(as.formula(paste('mpg ~', params$xvarB)), data = mtcars, pch = 19, col = 'gray')
abline(fit, col = 'red', lwd = 2)
```
