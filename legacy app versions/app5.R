...
server <- function(input, output, session) {
      ...
      isolate({
        ...
        tryCatch({
          withProgress(message = "Rendering report", value = 0.3, {
            Sys.sleep(0.5)
            # Render with execute_params to pass title, subtitle, and name to YAML header
  ...
  # Function to extract relevant parameters for comparison (added title, subtitle, name)
  ...
  ##### Load Report 1 parameters into current session (added title, subtitle, name) #####
observeEvent(input$load_report_1, {
  ...
  ##### Load Report 2 parameters into current session (added title, subtitle, name) #####
  ...
  ##### Generate comparison table (added title, subtitle, name) #####
  output$comparisonTable <- renderTable({
    ...
    for (param in all_params) {
      ...
      # Create readable parameter names (added title, subtitle, name)
