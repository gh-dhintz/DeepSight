        ...
        sidebarLayout(
          sidebarPanel(width = 3,
            ...
            conditionalPanel(
              ...
              h6("Sub-Caption for Plot A1", class = "text-secondary", style = "font-weight: bold;"),
              ...
              textInput("plotA_SubCaption_1", NULL, 
            ...
            conditionalPanel(
              ...
              h6("Sub-Caption for Plot A2", class = "text-secondary", style = "font-weight: bold;"),
              p("Sub-Captions are used only in the presence of multiple plots per figure", 
                class = "text-muted", style = "font-size: 12px; margin-bottom: 5px;"),
              textInput("plotA_SubCaption_2", NULL, 
                       placeholder = "Brief description of this plot")
            ),
            conditionalPanel(
              ...
              h6("Sub-Caption for Plot A3", class = "text-secondary", style = "font-weight: bold;"),
              p("Sub-Captions are used only in the presence of multiple plots per figure", 
                class = "text-muted", style = "font-size: 12px; margin-bottom: 5px;"),
              textInput("plotA_SubCaption_3", NULL, 
                       placeholder = "Brief description of this plot")
            ),
            
            # Shared settings for all Plot A
            br(),
          ...
          mainPanel(
            ...
            conditionalPanel(
              condition = "input.plotA_n >= 1",
              plotOutput("regPlotA_1", height = "300px")
            ),
            conditionalPanel(
              condition = "input.plotA_n >= 2",
              plotOutput("regPlotA_2", height = "300px")
            ),
            conditionalPanel(
              condition = "input.plotA_n >= 3",
              plotOutput("regPlotA_3", height = "300px")
            )
          )
        )
      ),
      ...
      tabPanel("Plot B",
        sidebarLayout(
          sidebarPanel(width = 3,
            ...
            conditionalPanel(
              ...
              selectInput("plotB_x_1", "X Variable for Plot B1:", 
                         choices = names(mtcars), selected = "wt"),
              h6("Sub-Caption for Plot B1", class = "text-secondary", style = "font-weight: bold;"),
              p("Sub-Captions are used only in the presence of multiple plots per figure", 
                class = "text-muted", style = "font-size: 12px; margin-bottom: 5px;"),
              textInput("plotB_SubCaption_1", NULL, 
                       placeholder = "Brief description of this plot")
            ),
            conditionalPanel(
              ...
              selectInput("plotB_x_2", "X Variable for Plot B2:", 
                         choices = names(mtcars), selected = "hp"),
              h6("Sub-Caption for Plot B2", class = "text-secondary", style = "font-weight: bold;"),
              p("Sub-Captions are used only in the presence of multiple plots per figure", 
                class = "text-muted", style = "font-size: 12px; margin-bottom: 5px;"),
              textInput("plotB_SubCaption_2", NULL, 
                       placeholder = "Brief description of this plot")
            ),
            conditionalPanel(
              ...
              selectInput("plotB_x_3", "X Variable for Plot B3:", 
                         choices = names(mtcars), selected = "disp"),
              h6("Sub-Caption for Plot B3", class = "text-secondary", style = "font-weight: bold;"),
              p("Sub-Captions are used only in the presence of multiple plots per figure", 
                class = "text-muted", style = "font-size: 12px; margin-bottom: 5px;"),
              textInput("plotB_SubCaption_3", NULL, 
                       placeholder = "Brief description of this plot")
            ),
            
            # Shared settings for all Plot B
            br(),
          ...
          mainPanel(
            conditionalPanel(
              condition = "input.plotB_n >= 1",
              plotOutput("regPlotB_1", height = "300px")
            ),
            conditionalPanel(
              condition = "input.plotB_n >= 2",
              plotOutput("regPlotB_2", height = "300px")
            ),
            conditionalPanel(
              condition = "input.plotB_n >= 3",
              plotOutput("regPlotB_3", height = "300px")
            )
          )
        )
      ),
...
server <- function(input, output, session) {
  ...
  onBookmarked(function(url) {
    ...
    if (download_requested()) {
      ...
      # Convert input to a regular list (scalable approach)
      all_inputs <- reactiveValuesToList(input)
      
      # Dynamically capture ALL plot inputs (scalable)
  ...
  for (i in 1:3) {  # Can be increased if max plots increases
    local({
      my_i <- i
