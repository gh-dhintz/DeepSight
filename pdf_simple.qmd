...
if (!is.null(params$plotA_x_1)) {
  x_var <- params$plotA_x_1
  ...
  p <- ggplot(mtcars, aes(x = .data[[x_var]], y = mpg)) +
    ...
    theme_minimal() +
    labs(title = "Plot A 1", x = x_var, y = "mpg") +
    theme(
...
#| label: notes-plotA-1
#| results: asis
#| eval: !is.null(params$plotA_notes_1)

if (!is.null(params$plotA_notes_1) && params$plotA_notes_1 != "") {
  cat("\n**Notes:**", params$plotA_notes_1, "\n\n")
}
```
...
if (!is.null(params$plotA_x_2)) {
  x_var <- params$plotA_x_2
  
  p <- ggplot(mtcars, aes(x = .data[[x_var]], y = mpg)) +
    geom_point(color = color_plotA_point, size = 3) +
    geom_smooth(method = "lm", se = FALSE, color = color_plotA_line) +
    theme_minimal() +
    labs(title = "Plot A 2", x = x_var, y = "mpg") +
    theme(
      plot.background = element_rect(fill = color_plot_background, color = NA),
      panel.background = element_rect(fill = color_plot_background, color = NA),
      text = element_text(color = color_fg),
...
if (!is.null(params$plotA_notes_2) && params$plotA_notes_2 != "") {
  cat("\n**Notes:**", params$plotA_notes_2, "\n\n")
}
```
...
if (!is.null(params$plotA_x_3)) {
  x_var <- params$plotA_x_3
  
  p <- ggplot(mtcars, aes(x = .data[[x_var]], y = mpg)) +
    geom_point(color = color_plotA_point, size = 3) +
    geom_smooth(method = "lm", se = FALSE, color = color_plotA_line) +
    theme_minimal() +
    labs(title = "Plot A 3", x = x_var, y = "mpg") +
    theme(
      plot.background = element_rect(fill = color_plot_background, color = NA),
      panel.background = element_rect(fill = color_plot_background, color = NA),
      text = element_text(color = color_fg),
...
if (!is.null(params$plotA_notes_3) && params$plotA_notes_3 != "") {
  cat("\n**Notes:**", params$plotA_notes_3, "\n\n")
}
```
...
if (!is.null(params$plotB_notes_1) && params$plotB_notes_1 != "") {
  cat("\n**Notes:**", params$plotB_notes_1, "\n\n")
}
```
...
if (!is.null(params$plotB_x_2)) {
  x_var <- params$plotB_x_2
  
  p <- ggplot(mtcars, aes(x = .data[[x_var]], y = mpg)) +
    geom_point(color = color_plotB_point, size = 3) +
    geom_smooth(method = "lm", se = FALSE, color = color_plotB_line) +
    theme_minimal() +
    labs(title = "Plot B 2", x = x_var, y = "mpg") +
    theme(
      plot.background = element_rect(fill = color_plot_background, color = NA),
      panel.background = element_rect(fill = color_plot_background, color = NA),
      text = element_text(color = color_fg),
...
if (!is.null(params$plotB_notes_2) && params$plotB_notes_2 != "") {
  cat("\n**Notes:**", params$plotB_notes_2, "\n\n")
}
```
...
if (!is.null(params$plotB_x_3)) {
  x_var <- params$plotB_x_3
  
  p <- ggplot(mtcars, aes(x = .data[[x_var]], y = mpg)) +
    geom_point(color = color_plotB_point, size = 3) +
    geom_smooth(method = "lm", se = FALSE, color = color_plotB_line) +
    theme_minimal() +
    labs(title = "Plot B 3", x = x_var, y = "mpg") +
    theme(
      plot.background = element_rect(fill = color_plot_background, color = NA),
      panel.background = element_rect(fill = color_plot_background, color = NA),
      text = element_text(color = color_fg),
...
if (!is.null(params$plotB_notes_3) && params$plotB_notes_3 != "") {
  cat("\n**Notes:**", params$plotB_notes_3, "\n\n")
}
```