#### Tracking changes ####
# - removed SubCaption element (all plot aestic/label varaibles will now be under Plot Annotations)
# 
...
generate_plot_A_content <- function(i, config, input) {
  ...
  combine_plot_A_components(plots, table_component, 
...
combine_plot_A_components <- function(plots, table_component,
   #final_caption,
    title, subtitle) {
