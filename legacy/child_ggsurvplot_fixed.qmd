...
message("CHILD GGSURVPLOT: ggsurvplot created")
...
message("CHILD GGSURVPLOT: About to print")
print(p1)
message("CHILD GGSURVPLOT: Print completed")
```