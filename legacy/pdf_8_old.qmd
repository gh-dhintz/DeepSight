...
```{r, results='asis'}
#| label: plotA-notes-copy

# Add notes if they exist
if (vars$plot_A_Notes_shared != "") {
  cat("\n**Notes for Plot A :**", vars$plot_A_Notes_shared, "\n\n")
  }
```
...
# Add notes if they exist
if (vars$plot_B_Notes_shared != "") {
  cat("\n**Notes for Plot A :**", vars$plot_B_Notes_shared, "\n\n")
  }
```
