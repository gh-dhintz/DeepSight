...
final_caption = plot_A_annotations[[paste0("plot_A_annotation_", i, "_7")]]
...
# FIXED: Get reference label using correct naming convention
ref_param_name <- paste0("plot_A_annotation_", i, "_1")  # Figure i, Panel 1 (reference label)
fig.plot.A.ref <- plot_A_annotations[[ref_param_name]]

# If no reference label is provided, create a default one
if (is.null(fig.plot.A.ref) || fig.plot.A.ref == "") {
  fig.plot.A.ref <- paste0("fig-A-", i)
}

# Remove any @ symbol if present (we'll add it back in the See statement)
...
my_pnl1_cap = plot_B_annotations[[paste0("plot_B_annotation_", i, "_4")]]
my_pnl2_cap = plot_B_annotations[[paste0("plot_B_annotation_", i, "_5")]]
my_pnl3_cap = plot_B_annotations[[paste0("plot_B_annotation_", i, "_6")]]
my_pnl4_cap = plot_B_annotations[[paste0("plot_B_annotation_", i, "_7")]]
final_caption = plot_B_annotations[[paste0("plot_B_annotation_", i, "_8")]]

x_var <- (plot_B_params[grepl("^plot_B_x[0-9]", names(plot_B_params))])[[i]]  # Extract the actual value here


# FIXED: Get reference label using correct naming convention
ref_param_name <- paste0("plot_B_annotation_", i, "_1")  # Figure i, Panel 1 (reference label)
...
# Get reference label - FIXED: Use new naming convention
...
final_caption = plot_D_annotations[[paste0("plot_D_annotation_", i, "_4")]]  # Only 4 annotations for Plot D
...
# Create flow data for treatment pathway visualization
...
# Create the treatment pathway flow plot
