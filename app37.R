...
server <- function(input, output, session) {
  ...
  if (length(extracted) > 0) {
    ...
    # Schedule updates after a delay with proper context
    later::later(function() {
      # Capture current input values at the time of execution
      current_inputs <- isolate(reactiveValuesToList(input))
      
      # Update inputs for all configured plot types
      for (plot_type in names(PLOT_CONFIG)) {
        config <- PLOT_CONFIG[[plot_type]]
        n_plots <- current_inputs[[paste0(plot_type, "_n")]]  # Use captured values
  ...
  observeEvent(input$load_basic_report, {
    preset_url <- "http://127.0.0.1:7931/?_inputs_&nav=%22Report%20Export%22&plots_subtabs=%22ESR1%20Dx%20Landscape%20(B)%22&load_basic_report=2&load_basic_report_two=0&update_and_copy_url=2&download_trigger=0&parse_url_1=0&parse_url_2=0&load_report_1=0&load_report_2=0&clear_comparison=0&refresh_log=0&clear_log=0&format=%22PDF%22&plot_A_n=1&plot_B_n=1&bookmark_url_1=%22%22&bookmark_url_2=%22%22&title=%22My%20Great%20Report%22&subtitle=%22With%20lots%20of%20plots%22&name=%22Johny%20Cash%22&plot_A_x1=%224%22&plot_A_Notes_shared=%22g%22&plot_A_annotation_1_1=%22%22&plot_A_annotation_2_1=%22a%22&plot_A_annotation_3_1=%22b%22&plot_A_annotation_4_1=%22c%22&plot_A_annotation_5_1=%22d%22&plot_A_annotation_6_1=%22e%22&plot_A_annotation_7_1=%22f%22&plot_B_x1=%224%22&plot_B_Notes_shared=%228%22&plot_B_annotation_1_1=%22%22&plot_B_annotation_2_1=%221%22&plot_B_annotation_3_1=%222%22&plot_B_annotation_4_1=%223%22&plot_B_annotation_5_1=%224%22&plot_B_annotation_6_1=%225%22&plot_B_annotation_7_1=%226%22&plot_B_annotation_8_1=%227%22"
